...
const ICON_LIST: IconType[] = [
	...
	},
	{
		name: "sun-icon",
		icon: SunIcon,
		keywords: ["sun", "weather", "clear", "day", "bright"],
	},
	{
		name: "cloud-icon",
		icon: CloudIcon,
		keywords: ["cloud", "weather", "overcast", "fog"],
	},
	{
		name: "rain-icon",
		icon: RainIcon,
		keywords: ["rain", "weather", "drizzle", "showers"],
	},
	{
		name: "snow-icon",
		icon: SnowIcon,
