...
const BrandOllamaIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
	({ size = 24, color = "currentColor", className = "" }, ref) => {
		...
		const start = useCallback(() => {
			...
			animate(".ollama-body", { scale: [1, 1.03, 1] }, { duration: 0.8, repeat: Infinity, ease: "easeInOut" });

			// Eyes blink - immediate and noticeable
			animate(".ollama-eye", { scaleY: [1, 0.1, 1] }, { duration: 0.2, delay: 0.3, repeat: Infinity, repeatDelay: 2 });

			// Nose wiggle - playful
			animate(".ollama-nose", { y: [0, -1, 1, 0] }, { duration: 0.3, repeat: Infinity, repeatDelay: 1 });
		}, [animate]);
