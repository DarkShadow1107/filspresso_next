...
const BrandAnthropicIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
	({ size = 24, color = "currentColor", className = "" }, ref) => {
		...
		const start = useCallback(() => {
			...
			animate(".anthropic-i", { rotateX: 22, skewX: -22, scaleY: 1.09 }, { duration: 0.2, ease: "easeInOut" });
		}, [animate]);

		const stop = useCallback(() => {
			animate(".anthropic-i", { rotateX: 0, skewX: 0, scaleY: 1 }, { duration: 0.2 });
		}, [animate]);
		...
		return (
			...
			>
				...
				{/* A */}
				<motion.g className="anthropic-a" style={{ transformBox: "fill-box", transformOrigin: "center" }}>
				...
				{/* Backslash */}
				<motion.g className="anthropic-i" style={{ transformBox: "fill-box", transformOrigin: "center" }}>
