...
let CardsController = class CardsController {
    ...
    async addCard(req) {
        const card = await this.cardsService.addCard(Number(req.user?.id), req.body);
        return { message: "Card added successfully", card };
    }
    async updateCard(req, id) {
        await this.cardsService.updateCard(Number(req.user?.id), id, req.body);
