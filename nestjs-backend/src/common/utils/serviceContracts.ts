...
function assertObject(value: any, context: string) {
  if (!value || typeof value !== "object" || Array.isArray(value)) {
    throw new Error(`${context} must be an object`);
  }
}

function assertString(value: any, context: string, maxLength = 512) {
...
function assertOptionalString(value: any, context: string, maxLength = 512) {
...
function assertNumber(value: any, context: string) {
  if (typeof value !== "number" || !Number.isFinite(value)) {
    throw new Error(`${context} must be a finite number`);
  }
}

function assertArray(value: any, context: string) {
  if (!Array.isArray(value)) {
    throw new Error(`${context} must be an array`);
  }
}

function assertOperationId(value: any, context = "operationId") {
...
function validateGoOpsEventIngestV1(payload: any) {
...
function validateKotlinQuoteRequestV1(payload: any) {
...
function validateKotlinQuoteResponseV1(payload: any) {
...
function validateRustCommitmentRequestV1(payload: any) {
...
function validateRustCommitmentResponseV1(payload: any) {
...
function validateRustVerifyRequestV1(payload: any) {
...
function validateRustVerifyResponseV1(payload: any) {
...
function validateInvoiceRenderRequestV1(payload: any) {
...
export const CONTRACT_VALIDATORS: Record<string, (payload: any) => void> = {
...
export function assertServiceContract(contractName: string, payload: any) {
