...
export default () => ({
	...
	port: toNumber(process.env.PORT, DEFAULT_PORT, 1, 65535),
	trustProxy: process.env.TRUST_PROXY,
	requestTimeoutMs: toNumber(process.env.REQUEST_TIMEOUT_MS, DEFAULT_REQUEST_TIMEOUT_MS, 5_000, 120_000),
	...
	apiRateLimitWindowMs: toNumber(process.env.API_RATE_LIMIT_WINDOW_MS, DEFAULT_API_RATE_LIMIT_WINDOW_MS, 60_000, 86_400_000),
	apiRateLimitMax: toNumber(process.env.API_RATE_LIMIT_MAX, DEFAULT_API_RATE_LIMIT_MAX, 100, 50_000),
