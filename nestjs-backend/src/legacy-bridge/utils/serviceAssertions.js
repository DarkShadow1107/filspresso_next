...
const { assertKeyUsage } = require("./keyUsagePolicy");
...
function verifyIssuer(iss) {
	if (SERVICE_ASSERTION_ISSUER_ALLOWLIST.length === 0) return true;
	return SERVICE_ASSERTION_ISSUER_ALLOWLIST.includes(String(iss || ""));
}
